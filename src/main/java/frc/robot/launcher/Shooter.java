...
public class Shooter {
    ...
    public void run() {
        ...
        if (Constants.operatorController.getTriggerAxis(Hand.kRight) >= Constants.kTriggerThreshold) {
            shoot();
        } else if (Constants.operatorController.getStartButton()) {
            turn();
        } else if (Constants.operatorController.getBackButton()) {
            rotate();
        } else {
            stop();
        }

        if (Constants.operatorController.getXButton()) {
            open();
        } else {
            close();
        }
    ...
    public void spinUp() {
         ...
         */
        if (Constants.operatorController.getStartButtonPressed()) {
            sped = Constants.SHOOTER_TARGET_RPM; //high speed, right side
        } else if (Constants.operatorController.getBackButtonPressed()) {
